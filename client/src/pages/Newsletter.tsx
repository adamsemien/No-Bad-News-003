...
export default function Newsletter() {
  return (
    <div className="min-h-screen bg-[#F9F8F6] flex flex-col items-center py-20 px-4 sm:px-6 lg:px-8">
      {/* Email Container - Simulating standard email width */}
      <div className="w-full max-w-[680px] bg-[#F9F8F6]">
        
        {/* Masthead */}
        <header className="mb-20 text-center pt-8">
          <h1 className="font-serif text-6xl tracking-[-0.03em] mb-4 font-extrabold text-[#1A1A1A]">
            <span className="text-[#922218]">NO BAD</span> NEWS
          </h1>
          <div className="flex justify-center mb-4">
            <div className="w-20 h-[0.5px] bg-[#1A1A1A]"></div>
          </div>
          <div className="flex items-center justify-center gap-4 text-[#1A1A1A]/60 font-sans text-xs tracking-wide uppercase py-1 font-light">
            <span className="opacity-80">Issue 001</span>
            <span className="opacity-40">•</span>
            <span className="opacity-80">Friday Morning</span>
          </div>
          <div className="font-serif text-lg tracking-wide text-[#1A1A1A] mt-3 mb-6 italic">
            For the stories that need to be told.
          </div>
        </header>

        {/* Quiet Top Banner */}
        <div className="w-full h-[180px] mb-20 overflow-hidden opacity-90">
          <img 
            src={bannerImage}
        ...
        <section className="mb-20">
          <h2 className="font-serif text-3xl font-bold tracking-[-0.03em] text-[#922218] uppercase mb-10 opacity-90">
            TL;DR - This Week in No Bad News
          </h2>
          <ul className="space-y-6 font-body text-[#1A1A1A] text-[17px] leading-[1.6] max-w-[95%]">
            <li className="group">
              <a href="#food" className="flex gap-4 w-full no-underline hover:opacity-80 transition-opacity">
                <span className="shrink-0 font-sans text-xs font-bold text-[#922218] tracking-wider w-20 pt-1.5">FOOD</span>
                <span className="group-hover:text-[#922218] transition-colors border-b border-transparent group-hover:border-[#922218]/20">My family’s Cajun gumbo recipe - finally on video</span>
              </a>
            </li>
            <li className="group">
              <a href="#hosting" className="flex gap-4 w-full no-underline hover:opacity-80 transition-opacity">
                <span className="shrink-0 font-sans text-xs font-bold text-[#922218] tracking-wider w-20 pt-1.5">HOSTING</span>
                <span className="group-hover:text-[#922218] transition-colors border-b border-transparent group-hover:border-[#922218]/20">A hosting move that instantly upgrades conversation</span>
              </a>
            </li>
            <li className="group">
              <a href="#tips" className="flex gap-4 w-full no-underline hover:opacity-80 transition-opacity">
                <span className="shrink-0 font-sans text-xs font-bold text-[#922218] tracking-wider w-20 pt-1.5">DROPS</span>
                <span className="group-hover:text-[#922218] transition-colors border-b border-transparent group-hover:border-[#922218]/20">A Rockefeller Center flex you can steal at the bar</span>
              </a>
            </li>
            <li className="group">
              <a href="#music" className="flex gap-4 w-full no-underline hover:opacity-80 transition-opacity">
                <span className="shrink-0 font-sans text-xs font-bold text-[#922218] tracking-wider w-20 pt-1.5">MUSIC</span>
                <span className="group-hover:text-[#922218] transition-colors border-b border-transparent group-hover:border-[#922218]/20">Frank Ocean “Strawberry Swing” - still undefeated</span>
              </a>
            </li>
            <li className="group">
              <a href="#design" className="flex gap-4 w-full no-underline hover:opacity-80 transition-opacity">
                <span className="shrink-0 font-sans text-xs font-bold text-[#922218] tracking-wider w-20 pt-1.5">DESIGN</span>
                <span className="group-hover:text-[#922218] transition-colors border-b border-transparent group-hover:border-[#922218]/20">A brand that turns desktop icons into real life</span>
              </a>
            </li>
          </ul>
        </section>
        <div className="w-[80%] mx-auto h-[0.5px] bg-[#1A1A1A]/20 mb-20"></div>

        {/* Editor's Note */}
        <section className="mb-20 pt-8">
          <h2 className="font-serif text-3xl font-bold tracking-[-0.03em] text-[#922218] mb-10">
            Editor’s Note - Adam’s Corner
          </h2>
          <div className="prose prose-neutral max-w-none font-body text-[#1A1A1A] text-[17px] leading-[1.6]">
            <p className="mb-6">
        ...
        <section className="mb-20 pt-8">
          ...
          <p className="font-body text-sm italic text-[#1A1A1A]/60 mb-10 font-medium">
          ...
          <div className="mb-14 flex justify-center mt-10">
            <div className="w-full max-w-[450px] relative group cursor-pointer">
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-[#922218]/10 to-transparent opacity-0 group-hover:opacity-20 transition-opacity duration-700 z-10 rounded-sm"></div>
          ...
          <div className="prose prose-neutral max-w-none font-body text-[#1A1A1A] text-[17px] leading-[1.6]">
            ...
            <p className="mb-6 font-bold text-[#922218]">
        ...
        {/* No Bad Food */}
        <section id="food" className="mb-20 pt-8">
          <h2 className="font-serif text-3xl font-bold tracking-[-0.03em] text-[#922218] mb-10">
            No Bad Food
          </h2>
          <p className="font-body text-sm italic text-[#1A1A1A]/60 mb-10 font-medium">
          ...
          <div className="prose prose-neutral max-w-none font-body text-[#1A1A1A] text-[17px] leading-[1.6]">
            ...
            <ul className="list-none space-y-4 mb-6 pl-0">
              <li><span className="text-[#922218] font-bold mr-2 text-xs uppercase tracking-wider">VIDEO</span> <a href="https://www.youtube.com/shorts/TftOIelM-j8" className="text-[#1A1A1A] hover:text-[#922218] transition-colors decoration-[rgba(26,26,26,0.1)] underline underline-offset-4">Watch on YouTube</a></li>
              <li><span className="text-[#922218] font-bold mr-2 text-xs uppercase tracking-wider">RECIPE</span> <span className="text-[#1A1A1A] hover:text-[#922218] cursor-pointer transition-colors decoration-[rgba(26,26,26,0.1)] underline underline-offset-4">Read full recipe + ingredients</span></li>
            </ul>
            <p>
        ...
        {/* Sponsor Slot 1 */}
        <div className="w-[80%] mx-auto h-[0.5px] bg-[#1A1A1A]/20 mb-20"></div>
        <div className="bg-[#922218] py-12 px-6 text-center mb-20">
          <p className="font-sans font-bold text-xs tracking-widest uppercase text-[#F9F8F6] opacity-90">
        ...
        {/* No Bad Hosting */}
        <section id="hosting" className="mb-20 pt-8">
          <h2 className="font-serif text-3xl font-bold tracking-[-0.03em] text-[#922218] mb-10">
            No Bad Hosting
          </h2>
          <p className="font-body text-sm italic text-[#1A1A1A]/60 mb-10 font-medium">
          ...
          <div className="prose prose-neutral max-w-none font-body text-[#1A1A1A] text-[17px] leading-[1.6]">
            ...
            <ul className="list-disc pl-5 mb-6 space-y-4 marker:text-[#922218]">
        ...
        {/* No Bad Tips */}
        <section id="tips" className="mb-20 pt-8">
          <h2 className="font-serif text-3xl font-bold tracking-[-0.03em] text-[#922218] mb-10">
            No Bad Drops
          </h2>
          <p className="font-body text-sm italic text-[#1A1A1A]/60 mb-10 font-medium">
          ...
          <div className="prose prose-neutral max-w-none font-body text-[#1A1A1A] text-[17px] leading-[1.6]">
            ...
            <ul className="list-disc pl-5 mb-8 space-y-6 marker:text-[#922218] font-light">
        ...
        {/* No Bad Music */}
        <section id="music" className="mb-20 pt-8">
          <h2 className="font-serif text-3xl font-bold tracking-[-0.03em] text-[#922218] mb-10">
            No Bad Music
          </h2>
          <p className="font-body text-sm italic text-[#1A1A1A]/60 mb-10 font-medium">
          ...
          <div className="prose prose-neutral max-w-none font-body text-[#1A1A1A] text-[17px] leading-[1.6] mb-8">
            <p className="mb-6">
          ...
          <div className="flex justify-center">
             <a href="https://www.youtube.com/watch?v=G7wcRZWRDdw" className="bg-[#922218] text-white font-sans font-medium py-4 px-12 rounded-[4px] hover:bg-[#7D1D15] transition-colors no-underline tracking-wide">
               Listen on YouTube
             </a>
          </div>
        </section>
        ...
        {/* No Bad Design */}
        <section id="design" className="mb-20 pt-8">
          <h2 className="font-serif text-3xl font-bold tracking-[-0.03em] text-[#922218] mb-10">
            No Bad Design
          </h2>
          <p className="font-body text-sm italic text-[#1A1A1A]/60 mb-10 font-medium">
          ...
          <div className="prose prose-neutral max-w-none font-body text-[#1A1A1A] text-[17px] leading-[1.6]">
            ...
            <ul className="list-disc pl-5 mb-6 space-y-1.5 marker:text-[#922218]">
            ...
            <ul className="list-none space-y-3 pl-0 mt-8 text-center sm:text-left">
              <li>Studio: <a href="https://www.nikolasbentelstudio.com" className="text-[#1A1A1A] hover:text-[#922218] underline decoration-[rgba(26,26,26,0.1)] underline-offset-4 transition-colors">nikolasbentelstudio.com</a></li>
              <li>Project: <a href="https://www.nikolasbentelstudio.com/projects/1bttwqzx" className="text-[#1A1A1A] hover:text-[#922218] underline decoration-[rgba(26,26,26,0.1)] underline-offset-4 transition-colors">View Project</a></li>
            </ul>
          </div>
        </section>
        ...
        <section className="mb-20 pt-8">
          ...
          <p className="font-body text-sm italic text-[#1A1A1A]/60 mb-12 font-medium">
            One thing actually worth leaving the house for.
          </p>

          <div className="prose prose-neutral max-w-none font-body text-[#1A1A1A] text-[17px] leading-[1.6]">
            <div className="mb-6">
              <h3 className="font-serif text-2xl text-[#1A1A1A] mb-2">Chloe’s Game</h3>
              <p className="font-serif italic text-lg text-[#1A1A1A]/60 mb-4">
                A Wednesday night for people who like their rooms electric and their poker competitive.
              </p>
              <div className="flex items-center gap-4 text-xs font-sans tracking-widest uppercase text-[#922218]">
                <span>Wednesdays</span>
                <span>•</span>
                <span>Austin, TX</span>
                <span>•</span>
                <a href="#" className="underline decoration-[#922218]/30 underline-offset-4 hover:text-[#1A1A1A] transition-colors">Request Invite</a>
              </div>
            </div>
          </div>
        ...
        <section className="mb-24 mt-12 md:mt-20 text-center px-4">
          <h2 className="font-serif text-xl font-bold tracking-tight text-[#922218] mb-6">
            Today’s Thought
          </h2>
          <p className="font-serif text-lg italic text-[#1A1A1A]/50 leading-loose">
        ...
        <div className="text-center pb-32">
          <p className="font-sans text-xs tracking-widest uppercase text-[#1A1A1A]/40 mb-8">
            For those who want the deeper cut…
          </p>
          <button className="bg-[#922218] text-white font-sans font-medium py-5 px-20 rounded-md mb-8 hover:bg-[#7D1D15] transition-colors cursor-pointer text-sm tracking-widest shadow-none opacity-90 hover:opacity-100 uppercase">
            Join The Red List
          </button>
        </div>
      </div>
      ...
      <div className="w-full bg-[#1A1A1A]/95 h-[70px] flex items-center justify-center mt-0">
        <p className="font-sans text-xs text-[#F9F8F6]/60 tracking-widest uppercase m-0 p-0">
